...
public class EditOrganizationLogoAction extends PortletAction {
	...
	public static final String TEMP_FOLDER_NAME =
		EditOrganizationLogoAction.class.getName();
	...
	public void processAction(
		...
		try {
			...
			if (command.equals(Constants.ADD_TEMP)) {
				...
				updateLogo(actionRequest, actionResponse, bytes);
	...
	protected void updateLogo(
		...
		byte[] croppedBytes = ImageToolUtil.getBytes(
			croppedImage, imageBag.getType());

		InputStream inputStream = null;

		try {
			inputStream = new ByteArrayInputStream(croppedBytes);
	...
	private static Log _log = LogFactoryUtil.getLog(
		EditOrganizationLogoAction.class);
